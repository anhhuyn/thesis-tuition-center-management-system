...
const EmptyState = ({ title, description, icon: Icon, onAdd, isTeacher }: { title: string; description: string; icon: any; onAdd?: () => void; isTeacher?: boolean }) => (
...
// Info Card component for student details
...
// Student Detail Panel Component - Detailed version
...
export const StudentTableSection = ({ subject, isTeacher = false }: Props) => {
  ...
  return (
    <div className="flex gap-6 w-full h-full min-h-[calc(100vh-200px)] p-4 md:p-6 bg-slate-50/40 transition-all duration-300">
      ...
      {/* RIGHT COLUMN - Student Detail Panel */}
